## Spp range estimates with higher concavity
...
write.csv(range_metrics, "/proj/hurlbertlab/gdicecco/avian-range-shifts/derived_data/range_metrics_sampled_hi_concav.csv", row.names = F)
