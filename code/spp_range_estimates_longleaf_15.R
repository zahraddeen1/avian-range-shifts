## Spp range estimates with 1.5 concavity
...
write.csv(range_metrics, "/proj/hurlbertlab/gdicecco/avian-range-shifts/derived_data/range_metrics_sampled_15_concav.csv", row.names = F)
